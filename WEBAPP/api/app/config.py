...
class Config:
    ...
    DATABRICKS_SOSTITUZIONE_ENDPOINT = os.getenv("DATABRICKS_SOSTITUZIONE_ENDPOINT")
    DATABRICKS_SOSTITUZIONE_TIMEOUT_SECONDS = int(os.getenv("DATABRICKS_SOSTITUZIONE_TIMEOUT_SECONDS", "120"))
    DATABRICKS_SPOSTAMENTO_ENDPOINT = os.getenv("DATABRICKS_SPOSTAMENTO_ENDPOINT")
    DATABRICKS_SPOSTAMENTO_TIMEOUT_SECONDS = int(os.getenv("DATABRICKS_SPOSTAMENTO_TIMEOUT_SECONDS", "120"))
